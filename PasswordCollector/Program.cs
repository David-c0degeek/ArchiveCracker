    ...
    private static void ProcessFiles(Options opts)
    {
        ...
        var allPasswords = allFiles.AsParallel()
            ...
            .SelectMany(file =>
            {
                ...
                Log.Information("Progress: {Processed}/{Total} files",
                    allFiles.Count - progressCounter.CurrentCount, allFiles.Count);
        ...
        allPasswords.AsParallel()
            ...
            .ForAll(password =>
            {
                ...
                {
                    Log.Information("Progress: {Processed}/{Total} passwords", processedPasswords,
                        allPasswords.Count);
                }
            });
