...
public static class Program
{
    ...
    private static async Task ProcessPasswordsAsync(Options options)
    {
        ...
        await ProcessBasePasswords(knownPasswords, strategies, variations, cancellationTokenSource);
    ...
    private static List<IPasswordVariationStrategy> InitializeStrategies()
    {
        return new List<IPasswordVariationStrategy>
        {
            new SimpleVariationsStrategy(),
            new ReversedStrategy(),
            new CharacterReplacementStrategy(),
            new AppendNumbersAndSymbolsStrategy(),
            new LeetSpeakStrategy(),
            new AppendPrependDatesStrategy(),
            new AppendPrependCommonSequencesStrategy(),
            new CapitalizeLettersStrategy(),
            new CommonPrefixesSuffixesStrategy(),
            new DoublePasswordStrategy(),
            new MirrorPasswordStrategy()
        };
    }

    private static async Task ProcessBasePasswords(
        HashSet<string> knownPasswords, 
        IReadOnlyCollection<IPasswordVariationStrategy> strategies, 
        ConcurrentQueue<string> variations, 
