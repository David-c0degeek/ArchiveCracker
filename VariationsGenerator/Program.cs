...
public static class Program
{
    ...
    {
        await ProcessPasswordsAsync();
    }

    private static async Task ProcessPasswordsAsync()
    {
        ...
        var knownPasswords = new HashSet<string>(File.ReadLines("passwords.txt"));
        var variations = new ConcurrentQueue<string>();
        var cancellationTokenSource = new CancellationTokenSource();
        var writeTask = WriteVariationsToFile(variations, "output.txt", cancellationTokenSource.Token);
    ...
    private static void ProcessBasePassword(string basePassword, IEnumerable<string> knownPasswords, IReadOnlyCollection<Func<string, IEnumerable<string>>> strategies, ConcurrentQueue<string> variations)
    {
    ...
    private static IEnumerable<string> GenerateVariations(string basePassword, IEnumerable<Func<string, IEnumerable<string>>> strategies)
    {
    ...
    private static async Task WriteVariationsToFile(ConcurrentQueue<string> variations, string filename, CancellationToken cancellationToken)
    {
